...
function Sidebar() {
    ...
    return (
        <div className="hidden w-[25%] flex-col gap-2 mr-2 text-main lg:flex">
            ...
            <div className="h-[85%] rounded bg-base">
                ...
                <div className="-4 m-2 flex flex-col items-start justify-start gap-1 rounded bg-nav p-4 font-semibold">
                    ...
                    <button className="mt-4 rounded-full bg-main px-4 py-1.5 text-[15px] text-invert hover:bg-muted hover:text-muted duration-200">创建播放列表</button>
                </div>
                <div className="-4 m-2 mt-4 flex flex-col items-start justify-start gap-1 rounded bg-nav p-4 font-semibold">
                    ...
                    <button className="mt-4 rounded-full bg-main px-4 py-1.5 text-[15px] text-invert hover:bg-muted hover:text-muted duration-200">浏览播客</button>
                </div>
            </div>
        </div>
    );
